...
@Autonomous (name = "Detect Prop Red Left")
public class DetectPropRedLeft extends LinearOpMode {

    // TFOD_MODEL_ASSET points to a model file stored in the project Asset location,
    // this is only used for Android Studio when using models in Assets.
    private static final String TFOD_MODEL_ASSET = "detect-red-prop.tflite";
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory toLeft = robot.trajectoryBuilder(forward.end())
                .lineToConstantHeading(new Vector2d(24, 41), new TranslationalVelocityConstraint(15), new ProfileAccelerationConstraint(20))
                .build();

        Trajectory toCenter = robot.trajectoryBuilder(forward.end())
                .lineToConstantHeading(new Vector2d(12, 32), new TranslationalVelocityConstraint(15), new ProfileAccelerationConstraint(20))
                .build();

        Trajectory toRight = robot.trajectoryBuilder(forward.end())
                .lineToLinearHeading(new Pose2d(11, 31, Math.toRadians(180)), new TranslationalVelocityConstraint(15), new ProfileAccelerationConstraint(20))
                .build();
        ...
        Trajectory fromCenter = robot.trajectoryBuilder(toCenter.end())
                .back(5)
                .build();
        ...
        switch (direction) {
            case 1:
                ...
                break;
            case 2:
                robot.followTrajectory(fromCenter);
                break;
            case 3:
