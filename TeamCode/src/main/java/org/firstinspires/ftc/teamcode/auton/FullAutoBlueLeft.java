...
@Autonomous (name = "Full Auto Blue Left")
public class FullAutoBlueLeft extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory toLeft = robot.trajectoryBuilder(forward.end())
                .lineToConstantHeading(new Vector2d(23, 41), new TranslationalVelocityConstraint(15), new ProfileAccelerationConstraint(20))
                .build();
